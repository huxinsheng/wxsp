...
public class MongoSourceConf {
    ...
    public SimpleMongoDbFactory mongoDbFactory(MongoClient mongoClient, MongoClientURI mongoClientURI) {
        log.info("初始化mongoDbFactory");
        return new SimpleMongoDbFactory(mongoClient, mongoClientURI.getDatabase());
    }

    @Bean
    public MongoTemplate mongoDaoSupport(@Qualifier("mongoDbFactory") SimpleMongoDbFactory mongoDbFactory) {
    ...
    public static void main(String[] args) {
        ...
        MongoTemplate mongoTemplate = new MongoTemplate(new SimpleMongoDbFactory(mongoClient, "wxsp"));
