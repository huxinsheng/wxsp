...
public class BasisMybatisPlusConf {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier(value = "basisGlobalConfig") GlobalConfiguration globalConfig,
        ...
        String mapperLocations = "classpath:db-wxsp/sql/**/*.xml";
        String configLocation = "classpath:db-wxsp/mybatis/mybatis-sqlconfig.xml";
        String typeAliasesPackage = "com.wxsp.entity.**";
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        String basePackage = "com.wxsp.db.mapper";
